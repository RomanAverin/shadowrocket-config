...
Группа `AutoGroup` автоматически тестирует все доступные в Shadowrocket прокси и выбирает туннель с минимальной задержкой. Проверка выполняется каждые 10 минут; для защиты от частых переключений задана разница в 100 мс.
